@block @block_timetable
Feature: The timetable block allows users to see upcoming events
  In order to enable the timetable block
  As a student
  I can add the timetable block to my dashboard
  ...
  Scenario: Next 30 days in course view
    ...
    And I click on "Sort timetable items" "button" in the "Timeline" "block"
  ...
  Scenario: All in course view
    Given I log in as "student1"
    And I click on "Filter timetable items" "button" in the "Timeline" "block"
